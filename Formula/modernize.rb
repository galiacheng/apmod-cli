class Modernize < Formula
  ...
  if OS.mac?
    if Hardware::CPU.intel?
      url "https://github.com/galiacheng/apmod-cli/releases/download/v0.0.211/modernize_0.0.211_darwin_x64.tar.gz"
      sha256 "472e12f37471f25de62431200b7466629a210a9d99854f979bc1c9bf988f1ee8"
    elsif Hardware::CPU.arm?
      url "https://github.com/galiacheng/apmod-cli/releases/download/v0.0.211/modernize_0.0.211_darwin_arm64.tar.gz"
      sha256 "04f23f2c57525a851ab270e3ae1c54fd5cfefd261279d711bba6c5e251df89c2"
    end
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/galiacheng/apmod-cli/releases/download/v0.0.211/modernize_0.0.211_linux_x64.tar.gz"
      sha256 "3b417f9df6cbedc2976655d2ca1ad4f867f49acd8e58ed18c5a1c027912e64cf"
    elsif Hardware::CPU.arm?
      url "https://github.com/galiacheng/apmod-cli/releases/download/v0.0.211/modernize_0.0.211_linux_arm64.tar.gz"
